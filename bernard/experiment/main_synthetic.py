...
k = 1000
tap_factors = [0.1, 0.3, 0.5, 0.7, 0.9]
mptap_factors = [0.1, 0.3, 0.5, 0.7, 0.9]
warm_ups = [0]  # , 100, 500, 1000, 5000]

path_base = '../datasets/synthetic/synthetic_1_'
paths = ['delay2.0', 'delay1.0', 'delay0.5', 'delay0.45', 'delay0.35', 'delay0.3', 'delay0.25', 'delay0.2', 'delay0.15',
         'delay0.1', 'delay0.05']

for p in paths:
    path = path_base + p + '.csv'
    ...
    results_tap.to_excel('./results/tap_res_synth_varco_' + p + '.xlsx')
    ...
    results_mptap.to_excel('./results/mptap_res_synth_varco_' + p + '.xlsx')
